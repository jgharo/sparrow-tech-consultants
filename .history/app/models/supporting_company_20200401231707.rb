class SupportingCompany < ApplicationRecord
  ...
  has_many :stlservices, inverse_of: :supporting_companies, foreign_key: 'supporting_company_id'
  has_many :scpaymentinfos, inverse_of: :supporting_companies, foreign_key: 'supporting_company_id'
