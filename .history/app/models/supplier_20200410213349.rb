class Supplier < ApplicationRecord
  ...
  validates :supplier_name, presence: true, length: {maximum: 30}, on: :create, allow_nil: false
  validates :supplier_phone, presence: true, length: {maximum: 12}, on: :create, allow_nil: false
  validates :supplier_email, presence: true, length: {maximum: 125}, on: :create, allow_nil: false
  validates :supplier_address, presence: true, length: {maximum: 250}, on: :create, allow_nil: false
