class ProdcategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @prodcategory.save
        format.html { redirect_to @prodcategory, notice: 'Category was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @prodcategory.update(prodcategory_params)
        format.html { redirect_to @prodcategory, notice: 'Category was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to prodcategories_url, notice: 'Category was successfully deleted  .' }
