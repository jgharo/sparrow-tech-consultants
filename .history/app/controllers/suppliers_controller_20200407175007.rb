class SuppliersController < ApplicationController
  ...
  private
    ...
    def supplier_params
      params.require(:supplier).permit(:supplier_name, :supplier_phone :supplier_email, :supplier_address, supplierpaymentinfos_attributes: [:id, :payment_address, :account_number, :routing_number, :aba_number, :swift_code, :_destroy], products_attributes: [:id, :product_name, :product_description, :product_cost, :prodcategory_id, :prodstatus_id, :date_modified, :_destroy])
    end
