class ProdstatusesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @prodstatus.save
        format.html { redirect_to @prodstatus, notice: 'Prodstatus was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @prodstatus.update(prodstatus_params)
        format.html { redirect_to @prodstatus, notice: 'Prodstatus was successfully updated.' }
  ...
  def destroy
    @prodstatus.destroy
    respond_to do |format|
      format.html { redirect_to prodstatuses_url, notice: 'Prodstatus was successfully destroyed.' }
