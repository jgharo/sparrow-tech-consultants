class SCompanyPaymentInfosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @s_company_payment_info.save
        format.html { redirect_to @s_company_payment_info, notice: 'Payment Info was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @s_company_payment_info.update(s_company_payment_info_params)
        format.html { redirect_to @s_company_payment_info, notice: 'Payment Info was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to s_company_payment_infos_url, notice: 'Payment Info was successfully deleted.' }
