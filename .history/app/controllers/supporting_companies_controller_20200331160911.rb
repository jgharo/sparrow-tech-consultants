class SupportingCompaniesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to supporting_companies_url, notice: 'Supporting company was successfully destroyed.' }
  ...
  private
    ...
    def supporting_company_params
      params.require(:supporting_company).permit(:supportingcomp_name, :supportingcomp_email, :scpaymentinfo_id, :stlservice_id)
    end
end
